...
\begin{document}
\begin{frontmatter}
	\title{One-Dimensional Screening Without Single-Crossing: Numerical Guided Approach.\footnote{Revision \textit{1.\svnrev}}} 
...
one-dimensional screening without the single-crossing condition. With the aid of numerical optimization tools, we guess which are the relevant binding incentive compatibility constraints.
